...
<body style="background-image: url(heading-bg.jpg);
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Testo</span></div>
<?php
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Remove</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
    $email = $row['email'];
